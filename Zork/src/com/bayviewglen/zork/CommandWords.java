...
class CommandWords {
	...
	private static final String validCommands[] = { "go", "move", "walk", "run", "save", "quit", "help", "eat", "move", "look", "read", "shine", "jump",
			"sit down", "stand up", "get", "talk", "attack", "shoot", "kill", "open", "close", "take", "all", "everything", "turn", "on", "drive", "in",
			"off", "inventory", "i", "north", "east", "west", "south", "up", "down", "n", "e", "w", "s", "u", "d", "info", "information" };
	
	private static final String validNouns[] = { "bag", "note", "car", "gun", "knife", "crossbow", "key", "desk", "chair", "table", "door", "sign",
