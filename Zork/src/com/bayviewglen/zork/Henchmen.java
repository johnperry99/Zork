...
public class Henchmen extends Character{
	public String[] instantiatePhrases = {"Hey! What are you doing here, kid?", "Hey! Who's that??", "I see someone!", 
			"An intruder! Get him!", "Someone's here!", "We've been infiltrated!", "Hey! You dare challenge the Saviours?",
			"Hey! Prepare to face the might of the Saviours!", "I see you!", "An intruder! Show him no mercy!", 
			"Hey you! Let's negotiate. You conede, and i'll definitely let you live."};
	
	public String randomPhrase() { //returns one of the phrases above - use this method when a room with any number of henchmen is entered.
